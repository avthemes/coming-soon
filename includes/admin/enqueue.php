...
function AV_CS_admin_enqueue() {
	...
	if( isset( $_GET['page'] ) 
		...
		wp_register_style( 'av_cs_toggle', plugins_url( '/assets/css/bootstrap.toggle.min.css', AV_CS_PLUGIN_URL ) );
		...
		wp_enqueue_script( 'av_cs_toggle', plugins_url( '/assets/js/bootstrap-toggle.min.js', AV_CS_PLUGIN_URL ), array( 'jquery' ), false, true );
